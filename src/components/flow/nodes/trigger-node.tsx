...
export function TriggerNode({ id, data }: { id: string; data: TriggerNodeData }) {
  ...
  return (
    <div className="relative group">
      <div className="absolute inset-0 bg-gradient-to-br from-amber-500/[0.02] to-transparent dark:from-amber-500/[0.05] rounded-2xl pointer-events-none transition-opacity duration-300 opacity-0 group-hover:opacity-100" />
      ...
      <div className="absolute inset-0 rounded-2xl ring-1 ring-inset ring-amber-500/[0.03] pointer-events-none" />
    </div>
  );
}
