...
type TriggerAction = 'new_lead' // Facebook
...
export function TriggerNode({
  ...
  return <div className="relative group bg-gradient-to-br from-amber-50/90 to-white dark:from-gray-900 dark:to-gray-800 rounded-xl border border-amber-100/50 dark:border-gray-700/50 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-2px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.5),0_2px_4px_-2px_rgba(0,0,0,0.25)] backdrop-blur-xl p-4 min-w-[300px] transition-all duration-300 hover:shadow-[0_0_30px_-5px_rgba(245,158,11,0.3)] dark:hover:shadow-[0_0_30px_-5px_rgba(245,158,11,0.2)] hover:translate-y-[-2px] hover:z-10">
      ...
      <div className="flex flex-col gap-4">
        ...
        {platform && <div className="flex flex-col gap-1.5">
            <Label className="text-xs font-medium text-amber-600/75 dark:text-amber-300/75">
              Select Trigger
            </Label>
            <Select value={action} onValueChange={handleActionChange}>
              ...
              <SelectContent>
                {platformActions[platform].map(a => <SelectItem key={a.value} value={a.value}>
                    {a.label}
                  </SelectItem>)}
              </SelectContent>
            </Select>
      ...
      <Handle type="source" position={Position.Right} className="w-2 h-4 !bg-amber-400 rounded-sm border-none !right-[0px] transition-all duration-300 hover:!bg-amber-500" />
