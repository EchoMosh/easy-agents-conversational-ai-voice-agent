...
export function TriggerNode({ id, data }: { id: string; data: TriggerNodeData }) {
  ...
  return (
    <div className="relative group bg-gradient-to-br from-amber-50/90 to-white dark:from-gray-900 dark:to-gray-800 rounded-xl border border-amber-100/50 dark:border-gray-700/50 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-2px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_6px_-1px_rgba(0,0,0,0.5),0_2px_4px_-2px_rgba(0,0,0,0.25)] backdrop-blur-xl p-4 min-w-[300px] bg-[length:200%_200%] animate-breathing">
