...
interface VariableSelectorProps {
  onSelectVariable: (
    variable: string,
    displayStyle?: VariableDisplayStyle,
  ) => void;
  triggerChar?: "@" | "#";
...
export function VariableSelector({
  ...
  const { data: customVariables = [], isLoading: isLoadingCustomVariables } =
    useQuery({
    ...
    return (
      <div className="variable-selector-popup" ref={commandRef}>
        ...
        <div className="fixed z-[9999] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[320px] w-full animate-in fade-in-0 zoom-in-95 duration-200">
          <div className="bg-background/95 dark:bg-gray-800/95 rounded-xl overflow-hidden border border-border/20 shadow-xl ">
                      ...
                      <div key={category} className="mb-3 last:mb-0">
                        ...
                        <div className="space-y-1.5">
                          {variables.map((variable, index) => {
                            ...
                            const flattenedIndex = filteredVariables.findIndex(
                              (v) => v.id === variable.id,
                            );
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className="w-[320px] p-0 bg-background/95 dark:bg-gray-800/95  rounded-xl overflow-hidden border border-border/20 shadow-lg animate-in zoom-in-95 duration-200"
        align="start"
      >
