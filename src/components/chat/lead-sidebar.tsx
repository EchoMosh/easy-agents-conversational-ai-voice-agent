...
export function LeadSidebar({
  ...
  return (
    <div
      className={`border-r flex flex-col bg-background min-w-[190px] ${className}`}
    >
      <div className="p-3 border-b">
        <div className="flex items-center justify-between mb-3">
          ...
          <Badge 
            variant="outline" 
            className="bg-primary/10 text-primary hover:bg-primary/15 text-xs px-1.5"
          >
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-7 pr-7 h-8 text-sm bg-muted/40 border-muted"
          />
          {searchTerm && (
            <Button
              variant="ghost"
      ...
      <div className="px-3 py-2 border-b">
        <div className="flex items-center gap-1.5">
          <Button
            ...
            size="sm"
            className="flex items-center gap-1 h-7 text-xs w-full justify-start bg-background border-muted"
          >
            <Filter className="h-3 w-3" />
            <span>Filter</span>
            {hasActiveFilters && (
              <Badge variant="secondary" className="ml-auto px-1 py-0 h-4 text-[10px]">
                {1}
              </Badge>
            )}
            ...
            filteredLeads.map((lead) => (
              ...
              >
                ...
                <div className="flex flex-col items-start gap-0.5 flex-1 text-left">
                  <h3 className="font-medium text-sm leading-none truncate max-w-[100px]">{lead.name}</h3>
