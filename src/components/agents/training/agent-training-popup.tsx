...
import { Check, Ear, Send, X } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
              ...
              >
                {message.role === "agent" && (
                  <Button
                    variant="ghost"
                    size="icon"
                    className={`absolute -top-1 -right-1 h-6 w-6 p-0 bg-white dark:bg-gray-700 rounded-full shadow-sm opacity-25 group-hover:opacity-100 transition-opacity ${
